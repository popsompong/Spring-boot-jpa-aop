...
//	@Before(value = "execution(* com.example.controller.*.*(..) and args(object)") //if method have one parameter intercepted
//	public void beforeAdvice (JoinPoint joinPoint, Object object) {
//		logger.info("Request = " + object);
//	}
	
//	@Before(value = "execution(* com.example.controller.*.*(..) and args(object1, object2)") //if method have two parameter intercepted
//	public void beforeAdvice (JoinPoint joinPoint, Object object1, Object object2) {
//		logger.info("Request = " + object1);
//	}
	
//	@After(value = "execution(* com.example.controller.*.*(..) and args(object)") //if method have one parameter intercepted
//	public void beforeAdvice (JoinPoint joinPoint, Object object) {
//		logger.info("Request = " + object);
//	}
